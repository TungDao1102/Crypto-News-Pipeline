...
```
Agent(
  prompt="Read C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/get-shit-done/templates/SECURITY.md`
