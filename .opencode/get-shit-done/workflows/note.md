...
- **Global scope**: `C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/notes/`)
...
2. Glob `C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/notes/` — works in any directory
