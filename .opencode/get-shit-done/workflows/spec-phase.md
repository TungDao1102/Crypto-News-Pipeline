...
```bash
INIT=$(node "C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/get-shit-done/templates/spec.md.
