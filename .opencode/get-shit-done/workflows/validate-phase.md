...
```
Agent(
  prompt="Read C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/get-shit-done/templates/VALIDATION.md`
