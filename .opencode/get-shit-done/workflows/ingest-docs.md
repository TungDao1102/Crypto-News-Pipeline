...
```bash
INIT=$(node "C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
