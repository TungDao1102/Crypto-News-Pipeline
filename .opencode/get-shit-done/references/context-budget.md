...
The keys live in `.claude/settings.json` (project) or `C:/Users/daotu/Documents/Crypto-News-Pipeline/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
